...
-- 表的索引 `forward`
--
ALTER TABLE `forward` ADD PRIMARY KEY (`id`);
...
-- 表的索引 `speed_limit`
--
ALTER TABLE `speed_limit` ADD PRIMARY KEY (`id`);

--
-- 表的索引 `tunnel`
--
ALTER TABLE `tunnel` ADD PRIMARY KEY (`id`);
...
-- 表的索引 `user_tunnel`
--
ALTER TABLE `user_tunnel` ADD PRIMARY KEY (`id`);
...
--
ALTER TABLE `forward` MODIFY `id` int (10) NOT NULL AUTO_INCREMENT,
AUTO_INCREMENT = 164;

--
-- 使用表AUTO_INCREMENT `node`
--
ALTER TABLE `node` MODIFY `id` int (10) NOT NULL AUTO_INCREMENT,
AUTO_INCREMENT = 27;

--
-- 使用表AUTO_INCREMENT `speed_limit`
--
ALTER TABLE `speed_limit` MODIFY `id` int (10) NOT NULL AUTO_INCREMENT,
AUTO_INCREMENT = 70;

--
-- 使用表AUTO_INCREMENT `tunnel`
--
ALTER TABLE `tunnel` MODIFY `id` int (10) NOT NULL AUTO_INCREMENT,
AUTO_INCREMENT = 59;
...
--
ALTER TABLE `user_tunnel` MODIFY `id` int (10) NOT NULL AUTO_INCREMENT,
AUTO_INCREMENT = 56;
